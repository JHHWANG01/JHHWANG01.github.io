...
`2009.03 ~ 2012.03`  수원 동원고등학교
`2014.01 ~ 2015.10` 군대
`2013.03 ~ 2019.03`  한신대학교 (정보통신학부)
...
`2015.03 ~ 2016.03` 실습실 조교 (근로 장학)
`2016.03 ~ 2017.12` 인터넷 어플리케이션 랩실장
`2017.03 ~ 2018.06` 신입생 세미나 교육
`2017.03 ~ 2017.12` 유닉스 조교 , 운영체제 조교
`2018.03 ~ 2018.06` 논문(창문 관리 시스템)

#### 인턴
`2018.09 ~ 2018.12` (주) 뉴젠씨앤아이 (4개월)
`실무` 회사 제품의 이슈 확인 및 테스트 / 테스트 결과 토대로 문서작업
회사 제품 가이드 제작, 유지보수 툴 개발

#### 프로젝트 수행사항

`2018.03 ~ 2018.06` 아두이노와 앱 인벤터를 이용한 환경수치확인/ 아두이노와 앱 인벤터 활용
`2018.03 ~ 2018.06` 유지보수 툴 개발/ 자바 스윙을 사용하여 유지보수에 필요한 정보 파싱.
